...
$sql=mysqli_query($link,"insert into doctorSpecilization(specilization) values('".$_POST['doctorspecilization']."')");
...
if(isset($_GET['del']))
		  {
		        $link=mysqli_connect("localhost","root",'',"hms");	 
		          mysqli_query($link,"delete from doctorSpecilization where id = '".$_GET['id']."'");
					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<p style="color:red;">
								<?php $msg=""; echo htmlentities($_SESSION['msg']=$msg);?></p>	
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
                                              <?php
                                                  $link = mysqli_connect("localhost", "root",'',"hms");
                                                 $sql=mysqli_query($link,"select * from doctorSpecilization");
                                                  $cnt=1;
