...
$sql=mysqli_query($link,"update  doctorSpecilization set specilization='".$_POST['doctorspecilization']."', updationDate='$currentTime'where id='$id'");
...
$link=mysqli_connect("localhost","root",'',"hms");
$id=intval($_GET['id']);
	$sql=mysqli_query($link,"select * from doctorSpecilization where id='$id'");
